        ...
        <div className="row">
          <div className="col s12 m4">
            <div className="icon-block">
              ...
              <p className="light">
                <img src="http://res.cloudinary.com/chibuezeayogu/image/upload/v1514931709/healthy_lxexgy.jpg" alt="" className="responsive-img circle" />
              </p>
            </div>
          </div>
          <div className="col s12 m4">
            <div className="icon-block">
              ...
              <p className="light">
                <img src="http://res.cloudinary.com/chibuezeayogu/image/upload/v1514931310/chipotle_r7ykot.jpg" alt="" className="responsive-img circle" />
              </p>
            </div>
          </div>
          <div className="col s12 m4">
            <div className="icon-block">
              ...
              <p className="light">
                <img src="http://res.cloudinary.com/chibuezeayogu/image/upload/v1514931037/one_pot_rl7hxc.jpg" alt="" className="responsive-img circle" />
              </p>
            </div>
          </div>
        </div>
