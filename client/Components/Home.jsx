        ...
        <div className="container overlay-bg">
          ...
          <div className="row center">
            <h4 className="col s12 light white-text">
              More-Recipes provides a platform for users to share awesome and 
        ...
        <div className="row">
          <div className="col s12 m4">
            <div className="icon-block">
              <h5 className="center home-recipes-title">
                Healthy Thanksgiving Recipes
              </h5>
              <p className="light">
                <img src={'https://res.cloudinary.com/chibuezeayogu/image/'+
      ...
      <div className="section">
        <div className="row">
          <div className="col s12 center">
            ...
            <h4 className="home-recipes-title">
              Importance of sharing ideas...</h4>
            <p 
              className="left-align light ideas-content">
              Ideas are never something you want to hold like you own them, 
              they aren’t currency. Ideas are temporary and others will have 
              the same ideas anyway. Connections are more important. Connecting
              ideas is where innovation comes from, and connecting with people
              makes those innovation come to life. Ideas aren’t important to 
              hold on to, their only importance is in sharing them with others. 
              Make yourself open and share with others what you have learnt.
            </p>
          </div>
        </div>
      </div>
